...
## Supervised Learning
Random Forest, Naive Bayes, and XGBoost models were all fit on various combinations of the climatic and elevation features to predict EPA Level 1 ecoregions.  XGBoost classifier produced the best results with precision of 0.97 and recall of 0.97.  No difference difference was found between the different combinations of features and engineered features for the various models produced.  Typically, however, precipitation related features were found to have the greatest importance in model prediction of ecoregion.  Errors in classification were found to typically be between closely related ecoregions.  These errors were likely a result of ecotones of environmental variables between two closely related ecosystems.  
